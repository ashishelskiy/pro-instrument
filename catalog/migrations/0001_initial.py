    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, verbose_name='Название')),
                ('slug', models.SlugField(blank=True, max_length=255, unique=True, verbose_name='URL')),
                ('image', models.ImageField(blank=True, help_text='Загрузите изображение для категории (рекомендуемый размер: 400x400)', null=True, upload_to='categories/', verbose_name='Изображение категории')),
                ('icon', models.CharField(blank=True, default='fa-folder-open', help_text='Выберите иконку из Font Awesome: fa-drill, fa-hammer, fa-saw, fa-tools и т.д.', max_length=50, verbose_name='Иконка (Font Awesome)')),
